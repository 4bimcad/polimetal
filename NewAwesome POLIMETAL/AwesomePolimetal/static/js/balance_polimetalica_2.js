//ES
// PROPIEDAD INTELECTUAL DE WEBSITE: http://polimetal.club/
// COPIAR O USAR PARTE DE CODICO SIN PERMISO DE ADMINISTRACION DE PoliMETAL.CLUB PROHIBIDO!!!!
// E-Mail para contactos: polimetalclub@gmail.com
// TODOS DERECHOS RESERVADOS

//EN
// INTELLECTUAL PROPERTY OF WEBSITE: http://polimetal.club/
// COPY OR USE PART OF CODE WITHOUT PERMISSION OF ADMINISTRATION OF PoliMETAL.CLUB PROHIBITED !!!!
// E-Mail for contacts: polimetalclub@gmail.com
// ALL RIGHTS RESERVED
...
//   if (window.location.href == "http://polimetal.club/calc_files/balance_met_polimetalica.html") {
//   balance();
// } else {
//   window.alert("ERROR 404. INTERNET CONNECTION WITH ´http://PoliMETAL.CLUB´ IS LOST. PLEASE, CHECK YOUR INTERNET CONNECTION.");
//   window.close();
// }
...
//Pb price converter and Cu PRICE TOTAL
...
//ADMINISTRACION GASTOS
    var  admin_gastos_2 = $("#admin_gastos_2").val();
    var  total_admin_gastos_2 = admin_gastos_2 * peso_Zn;
    $("#total_admin_gastos_2").html(total_admin_gastos_2.toLocaleString("en-US", {style: "currency", currency: "USD"}));
//MAQUILA GASTOS
...
//REFINACION Au
    var  refinacion_Au_2 = $("#refinacion_Au_2").val();
    var  total_refinacion_Au_2 = refinacion_Au_2 * $("#Au_peso_tm_venta_2").html();
    $("#total_refinacion_Au_2").html(total_refinacion_Au_2.toLocaleString("en-US", {style: "currency", currency: "USD"}));
//REFINACION Ag
    var  refinacion_Ag_2 = $("#refinacion_Ag_2").val();
    var  total_refinacion_Ag_2 = refinacion_Ag_2 * $("#Ag_peso_tm_venta_2").html();
    $("#total_refinacion_Ag_2").html(total_refinacion_Ag_2.toLocaleString("en-US", {style: "currency", currency: "USD"}));
//DEDUCCIONES TOTAL
    var total_deducciones_2 = gastos_exploracion_mitad_zn + 
                            gastos_fabrica_mitad_zn +
                            total_transporte + 
                            total_transporte_3 + 
                            total_admin_gastos_2 + 
                            total_maquila_gastos_2 + 
                            total_penalidades_gastos_2 + 
                            total_refinacion_Au_2 + 
                            total_refinacion_Ag_2 * 1; 
...
//RENTABILIDAD 
//Valor de 1 TM Pb
    var beneficio_1tm = beneficio_total / TMH / 2; 
    beneficio_1tm = beneficio_1tm || 0 //Nan to 0
    $("#beneficio_1tm").html(beneficio_1tm.toLocaleString("en-US", {style: "currency", currency: "USD"}));
// VALOR DE 1 TM DE CONCENTRADO DE MINERAL Pb
    var valor_1tm_conc = beneficio_total / peso_Pb;
...
//Valor de 1 TM Zn
    var beneficio_1tm_2 = beneficio_total_2 / TMH / 2; 
    beneficio_1tm_2 = beneficio_1tm_2 || 0 //Nan to 0
    $("#beneficio_1tm_2").html(beneficio_1tm_2.toLocaleString("en-US", {style: "currency", currency: "USD"}));
// VALOR DE 1 TM DE CONCENTRADO DE MINERAL Zn
    var valor_1tm_conc_2 = beneficio_total_2 / peso_Zn;
    valor_1tm_conc_2 = valor_1tm_conc_2 || 0 //Nan to 0
    $("#valor_1tm_conc_2").html(valor_1tm_conc_2.toLocaleString("en-US", {style: "currency", currency: "USD"}));
